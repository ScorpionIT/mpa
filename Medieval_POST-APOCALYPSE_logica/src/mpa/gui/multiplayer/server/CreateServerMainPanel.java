...
public class CreateServerMainPanel extends JPanel
{
		...
		launchButton.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseReleased(java.awt.event.MouseEvent e)
			{
				...
				else
				{
					...
					welcomeServer = new WelcomeServer(mapInfo.getNumberOfPlayers() - numberOfBots, map, difficultyLevelSelected, udpSpammer, mapInfo,
							worldLoader);
					welcomeServer.start();
	...
	public void setMap(String mapName)
	{
		...
		for (int i = 0; i <= mapInfo.getNumberOfPlayers() - 1; i++)
		{
			numberOfBotsBox.addItem(String.valueOf(i));
		}

		if (mapInfo.getNumberOfPlayers() - 1 > 0)
		{
