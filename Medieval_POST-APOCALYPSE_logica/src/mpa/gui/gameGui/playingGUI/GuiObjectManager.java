...
public class GuiObjectManager
{
	...
	public void addPlayer( String name, Vector2f hqPosition, Vector2f gatheringPlace,
			Vector2f direction, int life )
	{
		gameGui.getAssetManager().registerLocator(
				modelsPath + GameProperties.getInstance().getModelName( "player" ) + ".zip",
				ZipLocator.class );
		Spatial playerModel = gameGui.getAssetManager().loadModel(
				GameProperties.getInstance().getModelName( "player" ) + ".mesh.xml" );
		...
		gameGui.getAssetManager().registerLocator(
				modelsPath + GameProperties.getInstance().getModelName( "headquarter" ) + ".zip",
				ZipLocator.class );
		Spatial hqModel = gameGui.getAssetManager().loadModel(
				GameProperties.getInstance().getModelName( "headquarter" ) + ".mesh.xml" );
	...
	{
		LifeBar lifeBar = new LifeBar( gameGui.getAssetManager(), getModelBounds( model ),
				position.y );
	...
	private void addPlayerCircle( Vector3f position, String playerName, Spatial playerModel )
	{
		...
		if( playerName.equals( this.playingPlayer ) )
			...
			color = new Color( new Random().nextFloat(), new Random().nextFloat(),
	...
	{
		Circle2D circle2D = createCircle( playersColors.get( boss ), GameProperties.getInstance()
				.getObjectWidth( "minion" ) );
		gameGui.attachCircle( circle2D );
	...
	public void addResource( String type, int ID, Vector2f position )
	{
		...
		switch( type )
		{
			case "WOOD":
				gameGui.getAssetManager().registerLocator(
						modelsPath + GameProperties.getInstance().getModelName( "wood" ) + ".zip",
						ZipLocator.class );
				model = gameGui.getAssetManager().loadModel(
						GameProperties.getInstance().getModelName( "wood" ) + ".mesh.xml" );
			...
			case "FIELD":
				gameGui.getAssetManager().registerLocator(
						modelsPath + GameProperties.getInstance().getModelName( "field" ) + ".zip",
						ZipLocator.class );
				model = gameGui.getAssetManager().loadModel(
						GameProperties.getInstance().getModelName( "field" ) + ".mesh.xml" );
			...
			case "CAVE":
				gameGui.getAssetManager().registerLocator(
						modelsPath + GameProperties.getInstance().getModelName( "cave" ) + ".zip",
						ZipLocator.class );
				model = gameGui.getAssetManager().loadModel(
						GameProperties.getInstance().getModelName( "cave" ) + ".mesh.xml" );
			...
			case "MINE":
				gameGui.getAssetManager().registerLocator(
						modelsPath + GameProperties.getInstance().getModelName( "mine" ) + ".zip",
						ZipLocator.class );
				model = gameGui.getAssetManager().loadModel(
						GameProperties.getInstance().getModelName( "mine" ) + ".mesh.xml" );
	...
	{
		gameGui.getAssetManager().registerLocator(
				modelsPath + GameProperties.getInstance().getModelName( "minion" ) + ".zip",
				ZipLocator.class );
		Spatial minionModel = gameGui.getAssetManager().loadModel(
				GameProperties.getInstance().getModelName( "minion" ) + ".mesh.xml" );
	...
	{
		gameGui.getAssetManager().registerLocator(
				modelsPath + GameProperties.getInstance().getModelName( "towerCrusher" ) + ".zip",
				ZipLocator.class );
		Spatial towerCrusherModel = gameGui.getAssetManager().loadModel(
				GameProperties.getInstance().getModelName( "towerCrusher" ) + ".mesh.xml" );
	...
	public void updateTower( Vector2f position, String ID, int life )
	{
		...
		{
			gameGui.getAssetManager().registerLocator(
					modelsPath + GameProperties.getInstance().getModelName( "tower" ) + ".zip",
					ZipLocator.class );
			Spatial tower = gameGui.getAssetManager().loadModel(
					GameProperties.getInstance().getModelName( "tower" ) + ".mesh.xml" );
	...
	public synchronized void updatePlayerPosition( String name, Vector2f position,
			Vector2f direction, boolean isMoving, int life )
	{
	...
	public synchronized void updateMinionPosition( String ID, Vector2f position,
			Vector2f direction, boolean isMoving, String boss )
	{
	...
	public void updateTowerCrusherPosition( String ID, Vector2f position, Vector2f direction,
			boolean isMoving, String boss, int life )
	{
