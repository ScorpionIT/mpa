		...
		switch (index)
		{
			...
			case 1:
				if (p.getPlayerLevel().canBuy(Potions.MP, p.getPotionAmount(Potions.MP) + 1))
					return Potions.MP;
			case 2:
				if (p.getPlayerLevel().canBuy(Potions.GRANADE, p.getPotionAmount(Potions.GRANADE) + 1))
					return Potions.GRANADE;
			case 3:
				if (p.getPlayerLevel().canBuy(Potions.FLASH_BANG, p.getPotionAmount(Potions.FLASH_BANG) + 1))
